...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action="conf/aut_registrasi.php" method="post">
      ...
      <div class="text-center">
        <p class="mt-3">Sudah punya akun ? <a href="index.php?page=login-admin"><b>Login</b></a></p>
      </div>
    </div>
    <!-- /.card-body -->
  </div>
...
if(isset ($_GET['error'])){
  ...
  if ($error == 3) {
    ...
    <script>
        ...
        Toast.fire({
            icon: 'warning',
            title: 'Silahkan input username, password, dan konfirmasi password terlebih dulu !'
        })
    </script>";
  } 
  else if ($error == 4) {
